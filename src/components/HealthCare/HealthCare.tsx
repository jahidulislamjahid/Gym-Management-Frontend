    ...
    >
      <div className="bg-primary rounded-xl md:p-[60px] p-[10px] font-inter text-white md:w-[720px] md:h-[780px]">
        ...
        <p className="text-[14px] my-[12px]">
          Take a few minute to give us a call so that we can book you a schedule with one of our experienced trainer to get most out of the fitness related results
        </p>
